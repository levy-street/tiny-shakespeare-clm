...
_EXPECT: dict[str, tuple[tuple[str, int], ...]] = {
    ...
    # --- Extended: more common prev-words ---
    "all": (
        ("the", 6), ("my", 4), ("his", 3), ("her", 3), ("your", 3),
        ("thy", 3), ("our", 3), ("their", 3), ("this", 3), ("that", 3),
        ("these", 2), ("those", 2), ("men", 3), ("things", 2),
        ("you", 3), ("we", 2), ("they", 2), ("i", 2), ("he", 2),
        ("mine", 2), ("alike", 2), ("hail", 2), ("fair", 2), ("good", 2),
        ("is", 2), ("are", 2), ("were", 2), ("to", 2), ("is", 2),
        ("but", 2), ("in", 2), ("a", 2), ("o", 2),
    ),
    "from": (
        ("the", 6), ("my", 4), ("his", 4), ("her", 3), ("your", 2),
        ("thy", 3), ("our", 3), ("their", 2), ("this", 3), ("that", 3),
        ("these", 2), ("those", 2), ("me", 3), ("us", 2), ("him", 3),
        ("her", 2), ("them", 2), ("you", 3), ("thee", 3), ("hence", 2),
        ("whence", 2), ("england", 2), ("rome", 2), ("france", 2),
        ("whom", 2), ("which", 2),
    ),
    "upon": (
        ("the", 6), ("my", 4), ("his", 3), ("her", 3), ("your", 3),
        ("thy", 3), ("our", 3), ("their", 2), ("this", 3), ("that", 3),
        ("me", 3), ("us", 2), ("him", 2), ("her", 2), ("them", 2),
        ("you", 2), ("thee", 2), ("a", 3), ("such", 2), ("earth", 2),
    ),
    "make": (
        ("a", 4), ("the", 3), ("my", 3), ("his", 2), ("her", 2),
        ("your", 2), ("thy", 2), ("our", 2), ("their", 2), ("me", 3),
        ("us", 2), ("him", 2), ("her", 2), ("them", 2), ("you", 3),
        ("thee", 3), ("no", 2), ("an", 2), ("haste", 2), ("way", 2),
        ("known", 2), ("good", 2),
    ),
    "made": (
        ("a", 3), ("the", 2), ("my", 2), ("his", 2), ("her", 2),
        ("him", 2), ("me", 3), ("us", 2), ("them", 2), ("you", 3),
        ("thee", 3), ("of", 2), ("to", 2), ("by", 2), ("no", 2),
        ("up", 2), ("known", 2), ("good", 2), ("mad", 2),
    ),
    "said": (
        ("the", 2), ("my", 2), ("i", 4), ("he", 4), ("she", 3),
        ("thou", 3), ("you", 3), ("we", 2), ("they", 2), ("to", 3),
        ("so", 2), ("that", 2), ("this", 2), ("nothing", 2), ("unto", 2),
    ),
    "say": (
        ("i", 4), ("thou", 3), ("he", 3), ("she", 2), ("we", 2),
        ("they", 2), ("you", 3), ("it", 3), ("so", 3), ("this", 2),
        ("that", 2), ("no", 2), ("nothing", 2), ("the", 2), ("my", 2),
        ("unto", 2), ("to", 3), ("ay", 2), ("on", 2),
    ),
    "see": (
        ("the", 4), ("my", 3), ("his", 3), ("her", 2), ("your", 2),
        ("thy", 2), ("our", 2), ("their", 2), ("this", 3), ("that", 3),
        ("these", 2), ("a", 3), ("it", 3), ("him", 3), ("her", 2),
        ("them", 2), ("you", 3), ("thee", 3), ("me", 2), ("no", 2),
        ("how", 2), ("what", 2), ("where", 2), ("who", 2),
    ),
    "know": (
        ("the", 3), ("my", 2), ("his", 2), ("her", 2), ("your", 2),
        ("thy", 2), ("our", 2), ("their", 2), ("this", 2), ("that", 3),
        ("i", 4), ("thou", 3), ("he", 3), ("she", 2), ("we", 2),
        ("they", 2), ("you", 3), ("it", 3), ("him", 2), ("her", 2),
        ("them", 2), ("nothing", 2), ("no", 2), ("not", 3), ("what", 2),
        ("how", 2), ("when", 2), ("where", 2), ("who", 2), ("why", 2),
        ("thy", 2),
    ),
    "let": (
        ("me", 6), ("us", 5), ("him", 4), ("her", 3), ("them", 3),
        ("it", 3), ("thee", 2), ("the", 2), ("my", 2), ("thy", 2),
        ("no", 2), ("not", 2),
    ),
    "come": (
        ("to", 4), ("and", 3), ("the", 2), ("my", 2), ("now", 2),
        ("hither", 2), ("thither", 2), ("home", 2), ("forth", 2),
        ("here", 2), ("in", 2), ("on", 2), ("away", 2), ("not", 3),
        ("come", 2), ("down", 2), ("up", 2),
    ),
    "go": (
        ("to", 3), ("and", 3), ("we", 2), ("with", 3), ("get", 2),
        ("home", 2), ("forth", 2), ("hence", 2), ("thither", 2),
        ("along", 2), ("not", 3), ("on", 2), ("in", 2), ("out", 2),
        ("down", 2), ("up", 2),
    ),
    "pray": (
        ("thee", 6), ("you", 5), ("sir", 3), ("my", 3), ("thy", 2),
        ("the", 2), ("god", 2), ("heaven", 2), ("for", 2), ("to", 2),
        ("me", 2), ("tell", 2),
    ),
    "well": (
        ("said", 2), ("done", 2), ("spoke", 2), ("met", 2), ("come", 2),
        ("i", 2), ("then", 2), ("he", 2), ("she", 2), ("we", 2),
        ("my", 2), ("sir", 2), ("a", 2), ("for", 2),
    ),
    "so": (
        ("much", 3), ("many", 2), ("well", 3), ("far", 2), ("fair", 2),
        ("good", 2), ("noble", 2), ("long", 2), ("then", 2), ("the", 2),
        ("my", 2), ("i", 3), ("he", 2), ("she", 2), ("thou", 2),
        ("you", 2), ("we", 2), ("they", 2), ("it", 3), ("is", 2),
        ("as", 3), ("that", 3), ("to", 2), ("may", 2), ("shall", 2),
        ("will", 2), ("would", 2), ("do", 2),
    ),
    "even": (
        ("so", 3), ("the", 2), ("now", 2), ("as", 3), ("in", 2),
        ("to", 2), ("though", 2), ("thou", 2), ("i", 2), ("with", 2),
    ),
    "now": (
        ("i", 3), ("thou", 2), ("he", 2), ("she", 2), ("we", 2),
        ("they", 2), ("you", 3), ("the", 2), ("my", 2), ("thy", 2),
        ("his", 2), ("her", 2), ("is", 3), ("are", 2), ("will", 2),
        ("shall", 2), ("to", 2), ("by", 2), ("come", 2), ("let", 2),
        ("for", 2),
    ),
    "since": (
        ("the", 3), ("my", 2), ("thy", 2), ("his", 2), ("her", 2),
        ("our", 2), ("this", 2), ("i", 3), ("thou", 2), ("you", 2),
        ("we", 2), ("he", 2), ("she", 2), ("that", 2), ("when", 2),
        ("first", 2), ("last", 2), ("once", 2),
    ),
    "till": (
        ("the", 3), ("my", 2), ("thy", 2), ("his", 2), ("her", 2),
        ("our", 2), ("this", 2), ("i", 2), ("thou", 2), ("you", 2),
        ("we", 2), ("he", 2), ("she", 2), ("that", 2), ("now", 2),
        ("then", 2), ("death", 2), ("morning", 2), ("night", 2),
    ),
    "like": (
        ("a", 4), ("the", 3), ("my", 2), ("his", 2), ("her", 2),
        ("your", 2), ("thy", 2), ("our", 2), ("their", 2), ("this", 2),
        ("that", 2), ("these", 2), ("those", 2), ("an", 2), ("you", 2),
        ("me", 2), ("him", 2), ("her", 2), ("them", 2), ("to", 2),
        ("unto", 2),
    ),
    "against": (
        ("the", 4), ("my", 3), ("his", 3), ("her", 2), ("your", 2),
        ("thy", 2), ("our", 2), ("their", 2), ("this", 2), ("that", 2),
        ("me", 2), ("us", 2), ("him", 2), ("her", 2), ("them", 2),
        ("thee", 2), ("you", 2), ("all", 2),
    ),
    "under": (
        ("the", 4), ("my", 2), ("his", 2), ("her", 2), ("your", 2),
        ("thy", 2), ("our", 2), ("their", 2), ("this", 2), ("that", 2),
        ("heaven", 2),
    ),
    "sweet": (
        ("lord", 3), ("love", 3), ("lady", 2), ("friend", 2), ("prince", 2),
        ("father", 2), ("mother", 2), ("son", 2), ("wife", 2), ("heart", 2),
        ("soul", 2), ("rose", 2), ("gentle", 2), ("sir", 2), ("dear", 2),
        ("madam", 2), ("maid", 2),
    ),
    "dear": (
        ("lord", 3), ("friend", 3), ("son", 3), ("father", 2), ("mother", 2),
        ("brother", 2), ("sister", 2), ("heart", 2), ("love", 2), ("my", 2),
        ("wife", 2), ("cousin", 2), ("sir", 2), ("madam", 2), ("lady", 2),
        ("queen", 2), ("one", 2),
    ),
    "noble": (
        ("lord", 4), ("friend", 3), ("son", 2), ("father", 2), ("prince", 3),
        ("sir", 2), ("duke", 2), ("king", 2), ("lady", 2), ("queen", 2),
        ("brother", 2), ("earl", 2), ("man", 2), ("blood", 2), ("mind", 2),
        ("heart", 2), ("spirit", 2),
    ),
    "old": (
        ("man", 4), ("father", 3), ("friend", 2), ("time", 2), ("king", 2),
        ("news", 2), ("and", 2),
    ),
    "young": (
        ("lord", 3), ("prince", 3), ("man", 3), ("sir", 2), ("knight", 2),
        ("master", 2), ("boy", 2), ("blood", 2),
    ),
    "fair": (
        ("lady", 3), ("love", 3), ("sir", 2), ("one", 2), ("queen", 2),
        ("prince", 2), ("cousin", 2), ("friend", 2), ("maid", 2),
        ("lord", 3), ("daughter", 2), ("son", 2), ("youth", 2),
    ),
    "great": (
        ("king", 3), ("lord", 3), ("man", 2), ("prince", 2), ("master", 2),
        ("god", 2), ("queen", 2), ("cause", 2), ("love", 2), ("honour", 2),
        ("shame", 2), ("duke", 2), ("sir", 2), ("power", 2), ("sorrow", 2),
    ),
    "was": (
        ("a", 4), ("the", 4), ("an", 2), ("my", 3), ("his", 3),
        ("her", 3), ("your", 2), ("thy", 2), ("our", 2), ("their", 2),
    ...
    "were": (
        ("a", 3), ("the", 2), ("my", 2), ("his", 2), ("her", 2),
        ("not", 3), ("no", 2), ("i", 3), ("thou", 2), ("he", 2),
        ("she", 2), ("we", 2), ("they", 2), ("but", 2), ("as", 2),
        ("ever", 2), ("never", 2), ("it", 2), ("to", 2), ("in", 2),
    ),
    "been": (
        ("a", 3), ("the", 2), ("my", 2), ("so", 3), ("to", 2),
        ("with", 2), ("in", 2), ("at", 2), ("from", 2), ("of", 2),
        ("for", 2), ("upon", 2), ("as", 2), ("ever", 2), ("never", 2),
        ("here", 2), ("there", 2), ("thus", 2), ("more", 2),
    ),
    "seen": (
        ("the", 3), ("my", 2), ("his", 2), ("her", 2), ("your", 2),
        ("thy", 2), ("this", 2), ("that", 2), ("him", 2), ("her", 2),
        ("them", 2), ("you", 2), ("thee", 2), ("more", 2), ("any", 2),
        ("such", 2), ("a", 3), ("no", 2),
    ),
    "done": (
        ("the", 2), ("my", 2), ("his", 2), ("her", 2), ("to", 3),
        ("by", 2), ("with", 2), ("no", 2), ("so", 3), ("it", 2),
        ("thee", 2), ("you", 2), ("me", 2), ("him", 2), ("them", 2),
    ),
    "found": (
        ("the", 3), ("my", 2), ("his", 2), ("her", 2), ("a", 3),
        ("an", 2), ("them", 2), ("him", 2), ("her", 2), ("it", 2),
        ("me", 2), ("us", 2), ("no", 2), ("in", 2), ("by", 2),
    ),
    "must": (
        ("be", 5), ("have", 3), ("not", 3), ("needs", 3), ("i", 3),
        ("we", 3), ("he", 2), ("she", 2), ("thou", 2), ("you", 2),
        ("they", 2), ("speak", 2), ("go", 2), ("tell", 2), ("come", 2),
        ("know", 2),
    ),
    "may": (
        ("be", 4), ("not", 3), ("do", 2), ("have", 2), ("i", 2),
        ("we", 2), ("you", 2), ("thou", 2), ("he", 2), ("she", 2),
        ("come", 2), ("go", 2), ("see", 2), ("speak", 2), ("know", 2),
        ("hear", 2), ("give", 2), ("take", 2), ("make", 2), ("it", 3),
        ("this", 2), ("that", 2),
    ),
    "will": (
        ("i", 2), ("we", 2), ("not", 4), ("be", 4), ("have", 3),
    ...
    "one": (
        ("of", 4), ("the", 2), ("day", 2), ("night", 2), ("word", 2),
        ("that", 2), ("who", 2), ("by", 2), ("more", 2), ("after", 2),
        ("half", 2), ("and", 2),
    ),
    "out": (
        ("of", 5), ("the", 2), ("upon", 2), ("on", 2), ("and", 2),
        ("in", 2), ("to", 2), ("at", 2), ("with", 2), ("there", 2),
        ("here", 2), ("my", 2),
    ),
    "forth": (
        ("and", 2), ("to", 2), ("with", 2), ("the", 2), ("my", 2),
        ("his", 2), ("her", 2), ("our", 2), ("their", 2), ("from", 2),
    ),
    "back": (
        ("to", 3), ("and", 2), ("again", 2), ("with", 2), ("the", 2),
        ("my", 2),
    ),
    "away": (
        ("with", 3), ("from", 3), ("the", 2), ("and", 2), ("to", 2),
        ("now", 2), ("before", 2),
    ),
    # --- WH-words (question openers) ---
    "how": (
        ("now", 4), ("is", 3), ("doth", 3), ("dost", 3), ("do", 3),
        ("shall", 2), ("can", 2), ("could", 2), ("should", 2), ("camest", 2),
        ("came", 2), ("many", 2), ("much", 2), ("fares", 2), ("long", 2),
        ("say", 2), ("sayest", 2), ("think", 2), ("thinkest", 2),
        ("if", 2), ("art", 2),
    ),
    "why": (
        ("dost", 3), ("doth", 3), ("do", 3), ("does", 2), ("didst", 2),
        ("shouldst", 2), ("should", 2), ("is", 2), ("art", 2), ("then", 2),
        ("thou", 3), ("i", 2), ("he", 2), ("she", 2), ("we", 2), ("not", 2),
        ("this", 2), ("that", 2),
    ),
    "where": (
        ("is", 4), ("art", 4), ("was", 2), ("hast", 2), ("have", 2),
        ("hath", 2), ("shall", 2), ("doth", 2), ("dost", 2), ("did", 2),
        ("the", 2), ("my", 2), ("thy", 2), ("he", 2), ("she", 2), ("we", 2),
        ("they", 2), ("you", 2), ("i", 2),
    ),
    "whom": (
        ("i", 3), ("thou", 3), ("we", 2), ("he", 2), ("she", 2), ("they", 2),
        ("you", 2), ("the", 2), ("my", 2), ("thy", 2),
    ),
    "who": (
        ("is", 4), ("art", 3), ("was", 2), ("hath", 2), ("hast", 2),
        ("shall", 2), ("can", 2), ("comes", 2), ("came", 2), ("would", 2),
        ("could", 2), ("knows", 2), ("goes", 2), ("knew", 2), ("ever", 2),
    ),
    "when": (
        ("i", 3), ("thou", 3), ("he", 2), ("she", 2), ("we", 2), ("they", 2),
        ("you", 2), ("the", 2), ("my", 2), ("did", 2), ("first", 2),
        ("last", 2), ("shall", 2), ("will", 2), ("was", 2),
    ),
    "which": (
        ("i", 3), ("thou", 2), ("he", 2), ("is", 3), ("was", 2), ("hath", 2),
        ("shall", 2), ("doth", 2), ("the", 2), ("my", 2), ("makes", 2),
        ("made", 2), ("did", 2), ("do", 2), ("we", 2),
    ),
    # --- modals (strengthen) ---
    "would": (
        ("not", 4), ("be", 4), ("have", 3), ("do", 3), ("speak", 2),
        ("see", 2), ("go", 2), ("come", 2), ("give", 2), ("take", 2),
        ("say", 2), ("i", 3), ("we", 2), ("you", 2), ("he", 2), ("she", 2),
        ("thou", 2), ("rather", 2), ("fain", 2),
    ),
    "could": (
        ("not", 4), ("be", 3), ("have", 3), ("do", 2), ("see", 2),
        ("speak", 2), ("wish", 2), ("find", 2), ("tell", 2), ("hear", 2),
    ),
    "should": (
        ("not", 4), ("be", 3), ("have", 3), ("do", 2), ("speak", 2),
        ("i", 2), ("thou", 2), ("we", 2), ("he", 2), ("she", 2), ("you", 2),
        ("say", 2), ("think", 2), ("go", 2),
    ),
    "can": (
        ("not", 5), ("be", 3), ("do", 2), ("tell", 2), ("speak", 2),
        ("see", 2), ("say", 2), ("give", 2), ("make", 2), ("i", 2),
        ("we", 2), ("you", 2), ("he", 2), ("she", 2),
    ),
    "did": (
        ("not", 4), ("i", 3), ("we", 2), ("he", 2), ("she", 2), ("they", 2),
        ("you", 2), ("thou", 2), ("the", 2), ("my", 2), ("thy", 2),
        ("his", 2), ("her", 2), ("our", 2), ("ever", 2),
    ),
    # --- common pronouns (prev) ---
    "him": (
        ("that", 2), ("and", 2), ("to", 3), ("with", 2), ("in", 2),
        ("from", 2), ("by", 2), ("for", 2), ("a", 2), ("the", 2),
        ("who", 2),
    ),
    "her": (
        ("that", 2), ("and", 2), ("to", 3), ("with", 2), ("in", 2),
        ("from", 2), ("by", 2), ("for", 2), ("the", 2), ("own", 2),
        ("love", 2), ("heart", 2), ("eyes", 2),
    ),
    "them": (
        ("that", 2), ("and", 2), ("to", 3), ("with", 2), ("in", 2),
        ("from", 2), ("by", 2), ("for", 2), ("all", 2), ("a", 2),
        ("the", 2),
    ),
    "us": (
        ("all", 3), ("and", 2), ("to", 2), ("in", 2), ("with", 2), ("not", 2),
        ("that", 2), ("go", 2), ("be", 2), ("now", 2), ("a", 2),
    ),
    "thee": (
        ("and", 3), ("to", 3), (",", 2), ("not", 2), ("with", 2), ("in", 2),
        ("from", 2), ("i", 2), ("my", 2), ("thy", 2), ("by", 2), ("for", 2),
    ),
    "mine": (
        ("own", 5), ("eyes", 2), ("enemy", 2), ("and", 2), ("the", 2),
        ("of", 2), ("i", 2), ("in", 2),
    ),
    "thine": (
        ("own", 5), ("eyes", 2), ("enemy", 2), ("and", 2), ("of", 2),
        ("ear", 2),
    ),
    "ye": (
        ("shall", 2), ("are", 2), ("have", 2), ("all", 2), ("that", 2),
        ("not", 2), ("gods", 2), (",", 2),
    ),
    # --- common nouns (prev) ---
    "sir": (
        (",", 5), (".", 3), ("!", 2), ("?", 2), ("i", 3), ("the", 2),
        ("my", 2), ("we", 2), ("john", 2), ("andrew", 1),
    ),
    "madam": (
        (",", 5), (".", 3), ("!", 2), ("?", 2), ("i", 2), ("my", 2),
        ("the", 2),
    ...
    "lord": (
        (",", 4), (".", 3), ("!", 2), ("?", 2), ("of", 3), ("i", 2),
        ("and", 2), ("the", 2), ("my", 2), ("that", 2),
    ),
    "lady": (
        (",", 4), (".", 3), ("!", 2), ("?", 2), ("of", 2), ("and", 2),
        ("the", 2), ("my", 2), ("that", 2), ("i", 2),
    ),
    "king": (
        ("of", 3), ("and", 2), ("shall", 2), ("hath", 2), ("is", 3),
        ("was", 2), ("doth", 2), ("will", 2), ("that", 2), ("which", 2),
        ("henry", 2), ("richard", 1), ("john", 1), ("edward", 1),
    ),
    "queen": (
        ("of", 3), ("and", 2), ("is", 3), ("hath", 2), ("was", 2), ("the", 2),
        ("shall", 2), ("will", 2), ("doth", 2), ("that", 2), ("which", 2),
    ),
    "father": (
        (",", 3), (".", 2), ("!", 1), ("?", 2), ("of", 2), ("and", 2),
        ("hath", 2), ("is", 2), ("was", 2), ("doth", 2), ("i", 2),
    ),
    "mother": (
        (",", 3), (".", 2), ("!", 1), ("?", 2), ("of", 2), ("and", 2),
        ("hath", 2), ("is", 2), ("was", 2),
    ...
    "son": (
        (",", 3), (".", 2), ("of", 3), ("and", 2), ("hath", 2), ("is", 2),
        ("was", 2),
    ),
    "heart": (
        ("is", 3), (",", 3), (".", 2), ("of", 2), ("and", 2), ("to", 2),
        ("hath", 2), ("doth", 2), ("with", 2), ("in", 2),
    ),
    "soul": (
        ("is", 3), (",", 3), (".", 2), ("of", 2), ("and", 2), ("to", 2),
        ("hath", 2), ("doth", 2), ("with", 2), ("in", 2),
    ...
    "love": (
        ("is", 3), (",", 3), (".", 2), ("of", 2), ("and", 2), ("to", 2),
        ("hath", 2), ("doth", 2), ("thee", 2), ("thy", 2), ("me", 2),
        ("my", 2),
    ),
    "death": (
        (",", 3), (".", 2), ("is", 2), ("of", 2), ("and", 2), ("to", 2),
        ("hath", 2), ("doth", 2), ("shall", 2),
    ),
    "life": (
        (",", 3), (".", 2), ("is", 3), ("of", 2), ("and", 2), ("to", 2),
        ("hath", 2), ("doth", 2),
    ),
    "god": (
        (",", 3), (".", 2), ("of", 2), ("and", 2), ("save", 3), ("hath", 2),
        ("give", 2), ("forbid", 2), ("bless", 2),
    ),
    "heaven": (
        (",", 3), (".", 2), ("!", 2), ("and", 2), ("hath", 2), ("doth", 2),
        ("shall", 2), ("forbid", 2), ("bless", 2),
    ),
    "world": (
        (",", 3), (".", 2), ("is", 3), ("of", 2), ("and", 2), ("hath", 2),
        ("doth", 2),
    ),
    "time": (
        (",", 3), (".", 2), ("is", 3), ("of", 2), ("and", 2), ("hath", 2),
        ("doth", 2), ("shall", 2), ("will", 2), ("for", 2),
    ),
    "day": (
        (",", 3), (".", 2), ("!", 1), ("of", 2), ("is", 2), ("and", 2),
        ("hath", 2), ("shall", 2),
    ),
    "night": (
