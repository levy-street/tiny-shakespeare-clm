...
_VERBS = frozenset({
    ...
    # Common Shakespearean imperatives & finite verbs not captured above.
    "mourn", "mourns",
    "wash", "washes",
    "attend", "attends",
    "tip", "tips",
    ...
    "burn", "burns", "burnt", "burned",
    "shine", "shines", "shone", "shined",
